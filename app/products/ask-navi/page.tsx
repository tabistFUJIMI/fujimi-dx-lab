...
const FEATURES = [
  { icon: "🤖", title: "AI自動応答", description: "お客様からの質問にAIが即座に回答。営業時間外でも24時間対応できます。施術中・接客中でもお客様をお待たせしません。" },
  { icon: "📚", title: "かんたんナレッジ登録", description: "ナレッジとは「AIに覚えさせたい情報」のこと。メニュー表、料金表、よくある質問などをPDF・CSV・HPのURLで登録するだけ。AIが自動で整理・構造化します。" },
  { icon: "🌐", title: "Webウィジェット", description: "ホームページにチャットウィジェットを設置可能。サイト訪問者の疑問をその場で解決し、離脱を防いで予約・問い合わせにつなげます。" },
  { icon: "💬", title: "LINE連携", description: "公式LINEのトーク画面でそのまま利用できます。お客様は普段通りLINEするだけ。アプリダウンロードや会員登録は一切不要です。" },
  { icon: "📊", title: "会話履歴・分析", description: "どんな質問が多いか一目で分かるダッシュボード。未回答の質問も自動で検知してお知らせ。ナレッジの改善ポイントがすぐに見つかります。" },
  { icon: "🔔", title: "未回答検知・通知", description: "AIが答えられなかった質問を自動でピックアップ。管理者に通知され、ナレッジの追加ポイントがすぐに分かります。回答品質を継続的に改善できます。" },
  { icon: "🏷️", title: "業種別テンプレート", description: "サロン・飲食店・宿泊施設・ジム・ペットサロン・クリニックなど、業種ごとのナレッジテンプレートを用意。導入初日から実用レベルで動作します。" },
  { icon: "🌏", title: "多言語対応", description: "全プランで英語・中国語・韓国語などの多言語に対応。インバウンド顧客からの問い合わせにも自動で応対できます（別途翻訳設定は不要）。" },
  { icon: "🔗", title: "Reserve Navi連携", description: "Reserve Naviと連携すれば、予約データを活用してAIが自動でフォロー配信やリマインダーを作成。予約管理とAI応答をシームレスに統合できます。" },
];
