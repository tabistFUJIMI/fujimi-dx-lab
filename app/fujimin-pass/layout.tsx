...
export const metadata: Metadata = {
  ...
  description:
    "FUJIMIN PASSは小規模店舗向けDXシリーズ。LINE予約管理（ReserveNavi）、AI自動応答（AskNavi）、シフト管理（ShiftNavi）を月額¥980から。数社限定の共創パートナーも募集中。",
  openGraph: {
    title: "FUJIMIN PASS | 小さなお店の予約・AI応答・シフト管理",
    description:
      "施術院・サロン向け。LINE予約管理・AI自動応答・シフト管理を月額¥980から。共創パートナー募集中。",
