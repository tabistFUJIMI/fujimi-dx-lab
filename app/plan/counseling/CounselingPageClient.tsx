            ...
            <FadeIn>
              ...
              <div className="mt-10">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-xl bg-white px-8 py-4 text-base font-bold text-cyan-600 shadow-lg transition-all duration-300 hover:scale-105"
                >
                  今すぐ無料で始める
                </a>
                <p className="mt-3 text-sm text-cyan-100/60">クレジットカード不要・いつでも解約OK</p>
                <p className="mt-8 text-sm text-cyan-100/80">ご質問がある方は以下のフォームからどうぞ</p>
              </div>
              <div className="mt-6">
                <ContactForm />
              </div>
            ...
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "カウンセリングプラン",
                  item: "https://fujimi-dx-lab.com/plan/counseling",
                },
              ],
            }),
          }}
