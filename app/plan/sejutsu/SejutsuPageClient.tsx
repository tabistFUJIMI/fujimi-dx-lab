...
const PAIN_POINTS = [
  {
    emoji: "\u{1F4DE}",
    title: "施術中に電話が鳴るが手が離せない",
    text: "\u300C手が離せないのに電話が鳴る。中断するとお客様にも申し訳ないし、出なければ予約を逃してしまう。\u300D",
  },
  {
    emoji: "\u{1F4AC}",
    title: "LINEで\u300C何時空いてますか？\u300Dに何度も手動返信",
    text: "\u300C同じ質問にLINEで何度も手動で返信。営業時間外も通知が来て、気が休まらない。\u300D",
  },
  {
    emoji: "\u{1F4CB}",
    title: "スタッフのシフト調整がLINEグループで混乱",
    text: "\u300C希望シフトをLINEで集めて、Excelに転記して、調整して\u2026毎月2時間以上かかる。\u300D",
  },
];
...
const SOLUTIONS = [
  {
    ...
    label: "予約管理",
    name: "ReserveNavi",
    text: "LINE24時間受付。ダブルブッキングゼロ。もう電話で予約を受ける必要はありません。",
    free: false,
  },
  {
    emoji: "\u{1F916}",
  ...
  },
  {
    ...
    label: "シフト管理",
    name: "ShiftNavi",
    text: "スタッフの希望をスマホで収集\u2192AIがワンタッチで自動作成。",
    free: true,
  },
];
...
const FAQS = [
  ...
  {
    q: "ホットペッパーと併用できますか？",
    a: "はい。ホットペッパー経由の予約はそのまま、LINE直接予約をReserveNaviで管理する併用が可能です。",
  },
  {
    q: "ITに詳しくないのですが？",
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-800/80 p-5 shadow-2xl backdrop-blur-sm">
      ...
      <div className="mt-4 grid grid-cols-3 gap-3">
        {[
          { label: "今日の予約", value: "8件", color: "text-violet-400" },
          { label: "今月の来店", value: "142件", color: "text-green-400" },
          { label: "リピート率", value: "68%", color: "text-orange-400" },
        ].map((stat) => (
          <div
            key={stat.label}
      ...
      <div className="mt-3 space-y-2">
        {[
          { time: "10:00", name: "山田様", menu: "全身60分", status: "bg-green-400" },
          { time: "11:30", name: "佐藤様", menu: "肩首集中40分", status: "bg-violet-400" },
          { time: "13:00", name: "田中様", menu: "骨盤矯正50分", status: "bg-orange-400" },
        ].map((slot) => (
          <div
            key={slot.time}
...
export default function SejutsuPageClient() {
  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="relative z-10 mx-auto max-w-6xl">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                {/* Trust badges - compact under copy */}
                <FadeIn delay={0.25}>
                ...
                <FadeIn delay={0.3}>
                  <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                    <a
                      ...
                      className="inline-flex items-center justify-center rounded-2xl bg-orange-500 px-8 py-4 text-base font-bold text-white transition-all duration-300 hover:scale-105 hover:bg-orange-600"
                      style={{
          ...
          <div className="mx-auto max-w-4xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-3 max-w-md text-sm font-medium text-orange-600">
            ...
            <div className="mt-16 space-y-12">
              {SOLUTIONS.map((item, i) => (
                <FadeIn key={item.name} delay={i * 0.1}>
                  ...
                  >
                    {/* Icon side */}
                    <div className="flex shrink-0 items-center justify-center rounded-3xl border border-orange-100 bg-white p-8 shadow-sm md:h-40 md:w-40">
        ...
        >
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              {/* ShiftNavi */}
              <FadeIn delay={0.1}>
                <div className="group relative h-full rounded-3xl border border-orange-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <ul className="mt-6 space-y-3">
                    {[
                      ...
                      <li
                        ...
                        className="flex items-start gap-2.5 text-sm text-gray-600"
                      >
                        <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-orange-50 text-xs text-orange-500">
                          ✓
                        </span>
                        {item}
                      </li>
        ...
        >
          <div className="mx-auto max-w-4xl">
            ...
            <FadeIn delay={0.4}>
              <div className="mx-auto mt-10 max-w-2xl rounded-3xl border border-orange-100 bg-orange-50/50 p-6">
                ...
                >
                  ...
                  <div className="mt-6 space-y-4">
                    {[
                      ...
                      <div
                        key={row.feature}
                        className="flex items-center justify-between border-b border-orange-100 pb-3"
                      >
          ...
          <div className="mx-auto max-w-5xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-lg text-gray-500">
                  施術プランなら、毎月のFUJIMINポイントが増量でもらえます。
                </p>
                ...
                <FadeIn key={plan.name} delay={i * 0.08}>
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="mt-2 inline-block rounded-full bg-orange-100 px-3 py-1 text-xs font-semibold text-orange-600">
            ...
            <FadeIn>
              ...
              <div className="mt-10">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-xl bg-white px-8 py-4 text-base font-bold text-orange-600 shadow-lg transition-all duration-300 hover:scale-105"
                >
                  今すぐ無料で始める
                </a>
                <p className="mt-3 text-sm text-orange-100/60">クレジットカード不要・いつでも解約OK</p>
                <p className="mt-8 text-sm text-orange-100/80">ご質問がある方は以下のフォームからどうぞ</p>
              </div>
              <div className="mt-6">
                <ContactForm />
              </div>
            ...
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "施術プラン",
                  item: "https://fujimi-dx-lab.com/plan/sejutsu",
                },
              ],
            }),
          }}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "FUJIMIN PASS 施術プラン",
              applicationCategory: "BusinessApplication",
              operatingSystem: "Web",
              description:
                "整体・マッサージ・鍼灸院向けのLINE予約管理・AI自動応答・シフト管理システム",
              offers: {
                "@type": "AggregateOffer",
                lowPrice: "0",
                highPrice: "7700",
      ...
      {/* ── モバイル固定CTAバー ── */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 border-t border-orange-200 bg-white/95 p-3 backdrop-blur-sm transition-transform duration-300 md:hidden ${
