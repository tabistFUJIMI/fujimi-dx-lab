          ...
          <div className="mx-auto max-w-5xl">
            ...
            <FadeIn delay={0.1}>
              <div className="mx-auto mt-6 max-w-3xl">
                <EarlyBirdBanner variant="compact" accentColor="#f97316" productLabel="ReserveNavi" />
              </div>
            </FadeIn>
          ...
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            <FadeIn>
              ...
              <div className="mt-8">
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center rounded-2xl bg-white px-10 py-4 text-base font-bold text-orange-600 transition-all duration-300 hover:scale-105 animate-pulse"
                  style={{
            ...
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "施術プラン",
                  item: "https://www.fujimi-dx-lab.com/plan/sejutsu",
                },
              ],
            }),
          }}
