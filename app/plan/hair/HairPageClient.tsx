...
const PAIN_POINTS = [
  {
    emoji: "✂️",
    title: "カット中に電話が鳴って施術を中断",
    text: "「ハサミを持ったまま電話に出る。中断するとお客様にも申し訳ないし、出なければ予約を逃してしまう。」",
  },
  {
    emoji: "💬",
    title: "「指名予約できますか？」「カラーの所要時間は？」にDMで毎回返信",
    text: "「同じ質問にLINEやDMで何度も手動返信。営業時間外も通知が来て、気が休まらない。」",
  },
  {
    emoji: "📋",
    title: "スタイリストごとのシフトと指名予約の管理が煩雑",
    text: "「誰がいつ出勤で、指名の予約がどう入っているか。紙のシフト表では限界。」",
  },
];
...
const SOLUTIONS = [
  {
    ...
    label: "予約管理",
    name: "ReserveNavi",
    text: "LINE24時間受付。スタイリスト指名・指名料設定にも対応。カット+カラーの組合せメニューも。",
    free: false,
  },
  {
    emoji: "🤖",
  ...
  },
  {
    ...
    label: "シフト管理",
    name: "ShiftNavi",
    text: "スタイリストのシフトをスマホで管理。指名予約とシフトが連動。",
    free: true,
  },
];
...
const FAQS = [
  ...
  {
    q: "スタイリストの指名予約に対応していますか？",
    a: "はい。スタイリストごとの予約枠を設定でき、お客様がLINEから指名して予約できます。指名料の設定にも対応。",
  },
  {
    q: "お客様にアプリのダウンロードは必要？",
...
const MOCK_DESCRIPTIONS: Record<string, string> = {
  calendar:
    "週間タイムグリッドで予約状況を一目で把握。スタイリストごとの空き枠がリアルタイムで更新され、ダブルブッキングを完全に防止します。",
  line:
    "お客様はLINEからメニュー選択・スタイリスト指名・日時選択・予約確定まで4ステップで完了。アプリのダウンロードは一切不要です。",
  customer:
    "来店ごとの施術カルテを自動記録。髪質・カラー履歴・次回への申し送りまで、お客様の情報をチーム全員で共有できます。",
  ai:
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <FadeIn delay={0.15}>
          ...
          <div className="mt-8 text-center">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full border-2 border-violet-500 px-6 py-3 text-sm font-bold text-violet-600 transition-all duration-300 hover:bg-violet-50"
            >
              <span>💡</span>
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-800/80 p-5 shadow-2xl backdrop-blur-sm">
      ...
      <div className="mt-4 grid grid-cols-3 gap-3">
        {[
          { label: "今日の予約", value: "12件", color: "text-violet-400" },
          { label: "今月の来店", value: "186件", color: "text-green-400" },
          { label: "リピート率", value: "72%", color: "text-orange-400" },
        ].map((stat) => (
          <div
            key={stat.label}
      ...
      <div className="mt-3 space-y-2">
        {[
          { time: "10:00", name: "山田様", menu: "カット+カラー 120分", status: "bg-green-400" },
          { time: "12:00", name: "佐藤様", menu: "カット 60分（指名）", status: "bg-violet-400" },
          { time: "14:00", name: "田中様", menu: "パーマ 150分", status: "bg-orange-400" },
        ].map((slot) => (
          <div
            key={slot.time}
...
export default function HairPageClient() {
  ...
  return (
    <>
          ...
          <div className="relative z-10 mx-auto max-w-6xl">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <FadeIn delay={0.2}>
                  <p className="mt-6 max-w-lg text-lg leading-relaxed text-slate-300">
                    カット・カラー・パーマの予約管理、スタイリスト指名、シフト調整。全部LINEとAIにおまかせ。
                  </p>
                </FadeIn>
                ...
                <FadeIn delay={0.3}>
                  <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                    <a
                      ...
                      className="inline-flex items-center justify-center rounded-2xl bg-violet-600 px-8 py-4 text-base font-bold text-white transition-all duration-300 hover:scale-105 hover:bg-violet-700"
                      style={{
              ...
              <FadeIn delay={0.2} className="mt-8 lg:mt-0">
                <Image src="/images/plan/hair-hero.png" alt="hair" width={600} height={400} className="rounded-2xl shadow-2xl" priority />
              </FadeIn>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-3 max-w-md text-sm font-medium text-violet-600">
            ...
            <div className="mt-16 space-y-12">
              {SOLUTIONS.map((item, i) => (
                <FadeIn key={item.name} delay={i * 0.1}>
                  ...
                  >
                    {/* Icon side */}
                    <div className="flex shrink-0 items-center justify-center rounded-3xl border border-violet-100 bg-white p-8 shadow-sm md:h-40 md:w-40">
        ...
        >
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {/* AskNavi */}
              <FadeIn>
                <div className="group h-full rounded-3xl border border-violet-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                  <p className="text-xs font-bold tracking-widest uppercase text-violet-500">
                    AskNavi
                  </p>
                  ...
                  <ul className="mt-6 space-y-3">
                    {[
                      ...
                      >
                        <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-violet-50 text-xs text-violet-500">
                          ✓
                        </span>
                        {item}
                      </li>
              ...
              {/* ShiftNavi */}
              <FadeIn delay={0.1}>
                <div className="group relative h-full rounded-3xl border border-violet-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <FadeIn delay={0.3}>
              <div className="mt-10 text-center">
                <p className="text-2xl font-extrabold text-violet-600 md:text-3xl">
                  1日44分、月間約22時間を施術に使える
                </p>
                <p className="mt-3 text-xs text-gray-400">
                  ※ スタイリスト3名規模の美容室を想定した試算です
                </p>
              </div>
            </FadeIn>

            <FadeIn delay={0.4}>
              <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-violet-200 bg-white p-6">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {[
                      ...
                      <tr key={row.feature} className="hover:bg-violet-50/30">
                    ...
                    <tr className="border-t-2 border-violet-200 bg-violet-50/50">
                      ...
                      <td className="px-5 py-4 text-center text-lg font-extrabold text-violet-600">
                        ¥550/月〜
                      </td>
                    </tr>
                  </tbody>
          ...
          <div className="mx-auto max-w-5xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-lg text-gray-500">
                  ヘアサロンプランなら、毎月のFUJIMINポイントが増量でもらえます。
                </p>
                <div className="mx-auto mt-4 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-white px-5 py-2">
                  <span className="text-violet-500 font-bold text-sm">ℹ️</span>
                    ...
                    <div className="text-center">
                      <p
                        className={`text-sm font-semibold ${
                          plan.recommended ? "text-violet-600" : "text-gray-500"
                        }`}
                      >
                        {plan.name}
                      </p>
                      ...
                      <p className="mt-2 inline-block rounded-full bg-violet-100 px-3 py-1 text-xs font-semibold text-violet-600">
            ...
            <FadeIn>
              ...
              <div className="mt-10">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-xl bg-white px-8 py-4 text-base font-bold text-violet-600 shadow-lg transition-all duration-300 hover:scale-105"
                >
                  今すぐ無料で始める
                </a>
                <p className="mt-3 text-sm text-violet-100/60">クレジットカード不要・いつでも解約OK</p>
                <p className="mt-8 text-sm text-violet-100/80">ご質問がある方は以下のフォームからどうぞ</p>
              </div>
              <div className="mt-6">
                <ContactForm />
              </div>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "FUJIMIN PASS 美容室・ヘアサロンプラン",
      ...
      {/* ── モバイル固定CTAバー ── */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 border-t border-violet-200 bg-white/95 p-3 backdrop-blur-sm transition-transform duration-300 md:hidden ${
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 rounded-xl bg-violet-600 py-3 text-center text-sm font-bold text-white shadow-lg"
          >
            無料で始める
          </a>
        </div>
