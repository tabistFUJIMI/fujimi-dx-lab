          ...
          <div className="relative z-10 mx-auto max-w-6xl">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <FadeIn delay={0.2} className="mt-8 lg:mt-0">
                <Image src="/images/plan/hair-hero.jpg" alt="hair" width={600} height={400} className="rounded-2xl shadow-2xl" priority />
              </FadeIn>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <FadeIn delay={0.1}>
              <div className="mx-auto mt-6 max-w-3xl">
                <EarlyBirdBanner variant="compact" accentColor="#7c3aed" productLabel="ReserveNavi" />
              </div>
            </FadeIn>
