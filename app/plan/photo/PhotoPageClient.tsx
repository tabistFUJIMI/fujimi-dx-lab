                ...
                >
                  ...
                  <div className="mt-6 space-y-4">
                    {[
                      ...
                      { feature: "シフト管理", price: "ShiftNavi ¥0（無料）" },
                    ].map((row) => (
                      <div
                        key={row.feature}
          ...
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            <FadeIn>
              ...
              <div className="mt-8">
                <a
                  href="#contact"
                  className="inline-flex items-center justify-center rounded-2xl bg-white px-10 py-4 text-base font-bold text-indigo-600 transition-all duration-300 hover:scale-105 animate-pulse"
                  style={{
