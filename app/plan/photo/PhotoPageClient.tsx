...
const PAIN_POINTS = [
  {
    emoji: "📸",
    title: "撮影準備中や撮影中に予約の電話が入り対応できない",
    text: "「照明セッティング中やお客様のポーズを撮っている最中に電話が鳴る。中断すると空気が壊れる。」",
  },
  {
    emoji: "💬",
    title: "「七五三の撮影プランは？」「所要時間は？」に毎回メールやDMで返信",
    text: "「同じ質問にメールやInstagramのDMで何度も手動で返信。営業時間外も通知が来て、気が休まらない。」",
  },
  {
    emoji: "📋",
    title: "スタジオの空き状況と撮影スケジュールの管理が手作業",
    text: "「撮影スケジュールの管理、空き枠の確認、前後の準備時間の確保…手作業では限界。」",
  },
];
...
const SOLUTIONS = [
  {
    ...
    label: "予約管理",
    name: "ReserveNavi",
    text: "LINE24時間受付。撮影の種類（七五三・家族写真等）や利用人数を予約時に収集。時間枠予約にも対応。",
    free: false,
  },
  {
    emoji: "🤖",
    label: "AI自動応答",
    name: "AskNavi",
    text: "営業時間外もAIが即回答。撮影プラン・料金・持ち物・アクセス…よくある質問を自動化。",
    free: false,
  },
  {
    emoji: "📊",
    label: "シフト管理",
    name: "ShiftNavi",
    text: "スタジオのスケジュールをスマホで管理。撮影枠と連動。",
    free: true,
  },
];
...
const FAQS = [
  ...
  {
    q: "撮影の種類を選んでもらうことはできますか？",
    a: "はい。予約時に「七五三」「家族写真」「成人式」等の撮影種類を選択してもらえます。業種テンプレートで初期設定も簡単です。",
  },
  {
    q: "利用人数の収集はできますか？",
    a: "はい。予約時にお客様に人数を入力してもらえるので、当日の準備がスムーズになります。",
  },
  {
    q: "お客様にアプリのダウンロードは必要？",
...
const MOCK_DESCRIPTIONS: Record<string, string> = {
  calendar:
    "週間タイムグリッドで予約状況を一目で把握。スタジオの空き枠がリアルタイムで更新され、ダブルブッキングを完全に防止します。",
  line:
    "お客様はLINEから撮影種類選択・日時選択・人数入力・予約確定まで4ステップで完了。アプリのダウンロードは一切不要です。",
  customer:
    "来店ごとの撮影カルテを自動記録。撮影種類・衣装・ポーズの好み・次回への申し送りまで、お客様の情報をチーム全員で共有できます。",
  ai:
      ...
      <div className="mx-auto max-w-6xl">
        <FadeIn>
          <div className="text-center">
            <p className="text-xs font-bold tracking-widest uppercase text-indigo-600">
              Demo
            </p>
        ...
        <FadeIn delay={0.15}>
          ...
          <div className="mt-8 text-center">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full border-2 border-indigo-500 px-6 py-3 text-sm font-bold text-indigo-600 transition-all duration-300 hover:bg-indigo-50"
            >
              <span>💡</span>
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-800/80 p-5 shadow-2xl backdrop-blur-sm">
      ...
      <div className="mt-4 grid grid-cols-3 gap-3">
        {[
          { label: "今日の撮影", value: "4件", color: "text-indigo-400" },
          { label: "今月の撮影", value: "56件", color: "text-green-400" },
          { label: "リピート率", value: "65%", color: "text-orange-400" },
        ].map((stat) => (
          <div
            key={stat.label}
      ...
      <div className="mt-3 space-y-2">
        {[
          { time: "10:00", name: "山田様（4名）", menu: "七五三撮影", status: "bg-green-400" },
          { time: "13:00", name: "佐藤様（2名）", menu: "家族写真", status: "bg-indigo-400" },
          { time: "15:30", name: "田中様（1名）", menu: "成人式前撮り", status: "bg-orange-400" },
        ].map((slot) => (
          <div
            key={slot.time}
...
export default function PhotoPageClient() {
  ...
  return (
    <>
        ...
        <section
          ...
          style={{
            background: `
              ...
              linear-gradient(135deg, #1e1b4b 0%, #1a1744 50%, #0f0e2a 100%)
            `,
          }}
        >
                ...
                <FadeIn delay={0.3}>
                  <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                    <a
                      ...
                      className="inline-flex items-center justify-center rounded-2xl bg-indigo-600 px-8 py-4 text-base font-bold text-white transition-all duration-300 hover:scale-105 hover:bg-indigo-700"
                      style={{
          ...
          <div className="mx-auto max-w-4xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-3 max-w-md text-sm font-medium text-indigo-600">
            ...
            <div className="mt-16 space-y-12">
              {SOLUTIONS.map((item, i) => (
                <FadeIn key={item.name} delay={i * 0.1}>
                  ...
                  >
                    {/* Icon side */}
                    <div className="flex shrink-0 items-center justify-center rounded-3xl border border-indigo-100 bg-white p-8 shadow-sm md:h-40 md:w-40">
        ...
        >
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              {/* ShiftNavi */}
              <FadeIn delay={0.1}>
                <div className="group relative h-full rounded-3xl border border-indigo-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <ul className="mt-6 space-y-3">
                    {[
                      ...
                      <li
                        ...
                        className="flex items-start gap-2.5 text-sm text-gray-600"
                      >
                        <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-indigo-50 text-xs text-indigo-500">
                          ✓
                        </span>
                        {item}
                      </li>
            ...
            <FadeIn delay={0.3}>
              <div className="mt-12 text-center">
                ...
                <p className="mt-3 text-xs text-gray-400">
                  ※ 少人数運営の写真スタジオを想定した試算です
                </p>
              </div>
            </FadeIn>

            <FadeIn delay={0.4}>
              <div className="mx-auto mt-10 max-w-2xl rounded-3xl border border-indigo-100 bg-indigo-50/50 p-6">
                ...
                >
                  ...
                  <div className="mt-6 space-y-4">
                    {[
                      ...
                      <div
                        key={row.feature}
                        className="flex items-center justify-between border-b border-indigo-100 pb-3"
                      >
          ...
          <div className="mx-auto max-w-5xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-lg text-gray-500">
                  写真スタジオプランなら、毎月のFUJIMINポイントが増量でもらえます。
                </p>
                ...
                <FadeIn key={plan.name} delay={i * 0.08}>
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="mt-2 inline-block rounded-full bg-indigo-100 px-3 py-1 text-xs font-semibold text-indigo-600">
        ...
        >
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            <FadeIn>
              ...
              <p className="mx-auto mt-6 max-w-lg text-base leading-relaxed text-indigo-100/80">
                「うちでも使える？」「設定を手伝ってほしい」
                <br />
                なんでもお気軽にどうぞ。
              </p>
              <div className="mt-10">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-xl bg-white px-8 py-4 text-base font-bold text-indigo-600 shadow-lg transition-all duration-300 hover:scale-105"
                >
                  今すぐ無料で始める
                </a>
                <p className="mt-3 text-sm text-indigo-100/60">クレジットカード不要・いつでも解約OK</p>
                <p className="mt-8 text-sm text-indigo-100/80">ご質問がある方は以下のフォームからどうぞ</p>
              </div>
              <div className="mt-6">
                <ContactForm />
              </div>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "FUJIMIN PASS 写真スタジオプラン",
              applicationCategory: "BusinessApplication",
              operatingSystem: "Web",
              description:
                "写真スタジオ向けのLINE予約管理・AI自動応答・シフト管理システム",
              offers: {
                "@type": "AggregateOffer",
                lowPrice: "0",
                highPrice: "7700",
      ...
      {/* ── モバイル固定CTAバー ── */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 border-t border-indigo-200 bg-white/95 p-3 backdrop-blur-sm transition-transform duration-300 md:hidden ${
