...
const PAIN_POINTS = [
  {
    emoji: "🐕",
    title: "トリミング中に電話が鳴るが両手がふさがっている",
    text: "「ハサミを持ったまま電話は取れない。でも出なければ予約を逃してしまう。ワンちゃんも落ち着かなくなる。」",
  },
  {
    emoji: "💬",
    title: "「大型犬も対応していますか？」「料金はいくら？」に毎回電話やDMで返信",
    text: "「同じ質問にInstagramのDMやLINEで何度も手動で返信。営業時間外も通知が来て、気が休まらない。」",
  },
  {
    emoji: "📋",
    title: "トリマーのシフトと予約枠の調整がExcelで限界",
    text: "「希望シフトをLINEで集めて、Excelに転記して、予約枠と突き合わせて…毎月2時間以上かかる。」",
  },
];
...
const SOLUTIONS = [
  {
    ...
    label: "予約管理",
    name: "ReserveNavi",
    text: "LINE24時間受付。ペット情報（犬種・体重）の事前収集にも対応。飼い主様はLINEだけで完結。",
    free: false,
  },
  {
    emoji: "🤖",
    label: "AI自動応答",
    name: "AskNavi",
    text: "営業時間外もAIが即回答。料金・対応犬種・持ち物…飼い主様のよくある質問を自動化。",
    free: false,
  },
  {
    emoji: "📊",
...
const FAQS = [
  ...
  {
    q: "他の予約サイトと併用できますか？",
    a: "はい。他サイト経由の予約はそのまま、LINE直接予約をReserveNaviで管理する併用が可能です。",
  },
  {
    q: "ペット情報の事前収集はできますか？",
    a: "はい。予約時にペットの名前・犬種・体重を入力してもらえます。業種テンプレートで初期設定も簡単です。",
  },
  {
    q: "お客様にアプリのダウンロードは必要？",
...
const MOCK_DESCRIPTIONS: Record<string, string> = {
  calendar:
    "週間タイムグリッドで予約状況を一目で把握。トリマーごとの空き枠がリアルタイムで更新され、ダブルブッキングを完全に防止します。",
  line:
    "飼い主様はLINEからメニュー選択・トリマー指名・日時選択・予約確定まで4ステップで完了。アプリのダウンロードは一切不要です。",
  customer:
    "来店ごとのトリミングカルテを自動記録。犬種・体重・アレルギー・次回への申し送りまで、お客様の情報をチーム全員で共有できます。",
  ai:
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <FadeIn delay={0.15}>
          ...
          <div className="mt-8 text-center">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 rounded-full border-2 border-amber-500 px-6 py-3 text-sm font-bold text-amber-600 transition-all duration-300 hover:bg-amber-50"
            >
              <span>💡</span>
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-800/80 p-5 shadow-2xl backdrop-blur-sm">
      ...
      <div className="mt-4 grid grid-cols-3 gap-3">
        {[
          { label: "今日の予約", value: "6件", color: "text-amber-400" },
      ...
      <div className="mt-3 space-y-2">
        {[
          { time: "10:00", name: "ポチ（山田様）", menu: "トリミング", status: "bg-green-400" },
          { time: "11:30", name: "モコ（佐藤様）", menu: "シャンプーコース", status: "bg-amber-400" },
          { time: "13:00", name: "チョコ（田中様）", menu: "カット＋爪切り", status: "bg-orange-400" },
        ].map((slot) => (
          <div
            key={slot.time}
  ...
  return (
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{
            background: `
              ...
              radial-gradient(ellipse at 80% 20%, rgba(180,83,9,0.1) 0%, transparent 50%),
              linear-gradient(135deg, #292524 0%, #1c1917 50%, #0c0a09 100%)
            `,
          }}
        >
          <div className="relative z-10 mx-auto max-w-6xl">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <FadeIn delay={0.35}>
                  <p className="mt-6 inline-block rounded-full border border-amber-400/30 bg-amber-500/10 px-4 py-1.5 text-sm font-semibold text-amber-300">
        ...
        {/* ══════════════ Pain Points ══════════════ */}
        <section id="problems" className="bg-amber-50 px-4 py-24 md:py-32">
            ...
            <div className="mt-14 space-y-0">
              {PAIN_POINTS.map((p, i) => (
                <FadeIn key={p.title} delay={i * 0.08}>
                  ...
                  >
                    <span
                      className="shrink-0 text-4xl font-extrabold text-amber-200"
                      style={{ lineHeight: 1 }}
                    >
                      {i + 1}.
                    </span>
          ...
          <div className="mx-auto max-w-4xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-3 max-w-md text-sm font-medium text-amber-600">
            ...
            <div className="mt-16 space-y-12">
              {SOLUTIONS.map((item, i) => (
                <FadeIn key={item.name} delay={i * 0.1}>
                  ...
                  >
                    {/* Icon side */}
                    <div className="flex shrink-0 items-center justify-center rounded-3xl border border-amber-100 bg-white p-8 shadow-sm md:h-40 md:w-40">
        ...
        >
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              ...
              {/* ShiftNavi */}
              <FadeIn delay={0.1}>
                <div className="group relative h-full rounded-3xl border border-amber-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                  ...
                  <ul className="mt-6 space-y-3">
                    {[
                      ...
                      <li
                        ...
                        className="flex items-start gap-2.5 text-sm text-gray-600"
                      >
                        <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-amber-50 text-xs text-amber-500">
                          ✓
                        </span>
                        {item}
                      </li>
            ...
            <FadeIn delay={0.3}>
              <div className="mt-12 text-center">
                ...
                <p className="mt-3 text-xs text-gray-400">
                  ※ 少人数運営のペットサロンを想定した試算です
                </p>
              </div>
            </FadeIn>

            <FadeIn delay={0.4}>
              <div className="mx-auto mt-10 max-w-2xl rounded-3xl border border-amber-100 bg-amber-50/50 p-6">
          ...
          <div className="mx-auto max-w-5xl">
            <FadeIn>
              <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-lg text-gray-500">
                  ペットサロンプランなら、毎月のFUJIMINポイントが増量でもらえます。
                </p>
            ...
            <FadeIn delay={0.1}>
              <div className="mx-auto mt-6 max-w-3xl">
                <EarlyBirdBanner variant="compact" accentColor="#d97706" productLabel="ReserveNavi" />
              </div>
            </FadeIn>
                ...
                <FadeIn key={plan.name} delay={i * 0.08}>
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="mt-2 inline-block rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-600">
            ...
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 3,
                  name: "ペットサロンプラン",
                  item: "https://www.fujimi-dx-lab.com/plan/pet",
                },
              ],
            }),
          }}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "FUJIMIN PASS ペットサロンプラン",
              applicationCategory: "BusinessApplication",
              operatingSystem: "Web",
              description:
                "ペットサロン・トリミング向けのLINE予約管理・AI自動応答・シフト管理システム",
              offers: {
                "@type": "AggregateOffer",
                lowPrice: "0",
                highPrice: "7700",
      ...
      {/* ── モバイル固定CTAバー ── */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 border-t border-amber-200 bg-white/95 p-3 backdrop-blur-sm transition-transform duration-300 md:hidden ${
